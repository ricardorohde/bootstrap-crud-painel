            ...
            <div class="row">
                ...
                <?php 
                  if(isset($_POST['editar_sobre'])){
                    ...
                    echo "<div class='alert alert-info'>O membro da equipe foi cadastrado com sucesso</div>";
                  }
                ?>                
                          ...
                          <div class="panel-body">
                            <form method="post">
                              <div class="form-group">
                                ...
                                <textarea name="sobre" style="height: 140px;resize: vertical;" class="form-control">
                                  <?php echo $sobre; ?>
                                </textarea>
                              </div>
                      ...
                      <div id="lista_equipe_section" class="panel panel-default">
                          ...
                          <div class="panel-body">
                            <table class="table">
                              ...
                              ?>
                                  <tr>
                                  <td><?php echo ucwords($membro['id']); ?></td>
                                  <td><?php echo ucwords($membro['nome']); ?></td>
                                  <td><?php echo ucwords($membro['descricao']); ?></td>
                                  <td><button id_membro="<?php echo $membro['id']; ?>" class="btn btn-sm btn-danger deletar-membro">
                                    <span class="glyphicon glyphicon-trash"> Excluir</span></button></td>
                                  </tr>
                                <?php } ?>
                              </tbody>
                            </table>
